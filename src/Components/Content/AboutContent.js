      ...
      <div className="content-about-container">
        ...
        <div className="content-about-description">
          ...
          <div className="content-about-skills-container">
            ...
            <div className="content-about-skill-item item-3"><span>&#8226;</span> Flexbox, CSS-Grid and Bootstrap.</div>
          ...
          <div className="content-about-contact-info">
            ...
            <div className="content-about-socials-container">
              <div className="content-about-social-item" onClick={() => this.handleLinkClick("https://github.com/MickyDore/")}><img alt="github" src={`${iconPath}images/github.png`} href="https://github.com/MickyDore/" /></div>
              <div className="content-about-social-item" onClick={() => this.handleLinkClick("https://www.linkedin.com/in/micky-dore/")}><img alt="linkedin" src={`${iconPath}images/linkedin.png`} /></div>
            </div>
          </div>
        </div>
      </div>
